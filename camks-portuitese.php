...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <td height="72" bgcolor="#DCDCDC">
    <table width="100%" border="0">
      <tr>
        <td align="left" class="texto3">
          <img src="../images/logo.png" />beta
          <a class='ajax' href="../expliq/puai-pt.html" title="Por que beta? / Puaí beta?" style="text-decoration:none;"><img src="../images/nolib.png" alt="" /></a>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
  ...
  <tr>
    ...
    <td>
      <table border="0">
        <tr>
          <td width="165" class="texto2">Trazübbezão</td>
          <td width="19">&nbsp;</td>
          <td width="233">
            <table width="200" cellspacing="5" border="0">
              <tr>
                <td width="127">
                  <table background="../images/showlang.png" cellpadding="0" cellspacing="0" width="127" height="29">
                    <tr>
                      <td class="textas" align="center">Camкs</td>
                      <td><img src="../images/getlang.png" /></td>
                    </tr>
                  </table>
                </td>
                <td width="49">
                  <a href="../pt/ck" title="Inverter tradução / Invertrer trazübbezão" style="text-decoration:none;"><img src="../images/butchang.png" width="36" height="29" /></a>
                </td>
                <td width="10">
                  <table background="../images/showlang.png" cellpadding="0" cellspacing="0" width="127" height="29">
                    <tr>
                      <td width="117" align="center" class="textas">Portuitese</td>
                      <td width="10"><img src="../images/golang.png" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
          ...
          <td width="64">
            <a class='ajax' href="../expliq/dudtraz-pt.html" title="Botões / Buttions" style="text-decoration:none;"><img src="../images/nolib.png" alt="" /></a>
          </td>
        </tr>
      </table>
          ...
          <td rowspan="2" valign="top">
            <form id="traduz" action="">
              ...
              <table align="right">
                <tr>
                  <td>
                    <input name="traduzir" type="submit" class="textas" id="traduzir" value="Trazübber" />
                  </td>
                </tr>
              </table>
            </form>
          </td>
          <td valign="top" style="height:170px;" bgcolor="#f5f5f5">
            <br /><b>
            <div style="width:600px;" id="search_results"></div>
            </b>
          </td>
        </tr>
        <tr>
  ...
  <tr>
    ...
    <td>
      <p>
        <b>Note:</b>
        <br>
        You can try the translator with some expressions in Camks (and get the result in Portuguese):
        <ul>
          <li>Jim soiam + nœm (I am + name)</li>
          <li>Jim mi j'appeleave + nœm (I'm called + name)</li>
          <li>Jim soiam heppliz / trizte (I'm happy/sad)</li>
          <li>Jim manjeave panno (I eat bread)</li>
          <li>Jim zakeave dof côffá (I like coffee)</li>
          <li>Jim bôave vótér (I drink water)</li>
          <li>Jim veeave lhe homma/lha famma/lhe gharcino/lha gharcina (I see the man/woman/boy/girl)</li>
          <li>Jim zriteave unna carttre/unne libro (I write a letter/book)</li>
        </ul>
      </p>
    </td>
  </tr>
