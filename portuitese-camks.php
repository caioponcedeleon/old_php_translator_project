...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
    <td width="127"><table background="../images/showlang.png" cellpadding="0" cellspacing="0" width="127" height="29"><tr>
      <td class="textas" align="center">Portuitese</td><td><img src="../images/getlang.png" /></td></tr></table></td>
    <td width="49"><a href="../ck/pt" title="Inverter tradução / Invertrer trazübbezão" style="text-decoration:none;"><img src="../images/butchang.png" width="36" height="29" /></a></td>
    <td width="10"><table background="../images/showlang.png" cellpadding="0" cellspacing="0" width="127" height="29"><tr>
      <td width="117" align="center" class="textas">Camкs</td><td width="10"><img src="../images/golang.png" /></td></tr></table></td>
  </tr>
</table>
</td>
    ...
    <td><table width="476" border="0">
      ...
      <tr class="textas">
        <td rowspan="2" valign="top"><form id="traduz" action="">
          ...
          <input name="dpa" type="hidden" id="dpa" value="green" />
          <table align="right">
